import { MdRoofing, MdOutlineBedroomParent } from "react-icons/md";



export const HeaderBuy = [
  {
    id: "0a8dcd0a-d08b",
    image: "https://res.cloudinary.com/dr7qigh2d/image/upload/v1652197821/tiny-housing/tmp-1-1652197818014_rakj8t.jpg",
    icon: <MdRoofing />,
    category: "buy",
    title: "Tiny houses quality, sustainable and ecological.",
...
export const HeaderRent = [
  {
    id: "0a8dcf4e-d08b",
    image: "https://res.cloudinary.com/dr7qigh2d/image/upload/v1652133266/tiny-housing/tmp-3-1652133265737_cutsmr.jpg",
